...
Note that due to the regular changes to KeYmaera X, the component-based approach is currently not fully functional on the master branch.
The branch "cbrunning" contains the latest running version of che component-based approach.
